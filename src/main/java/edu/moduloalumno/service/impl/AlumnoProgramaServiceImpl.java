...
public class AlumnoProgramaServiceImpl implements IAlumnoProgramaService {
	...
	@Override
	public List<AlumnoPrograma> getAlumnoProgramasIdByCod(String cod) {
		List<AlumnoPrograma> alumnoProgramaList = alumnoProgramaDAO.getAlumnoProgramasIdByCod(cod); // DEV
		return alumnoProgramaList;
	}

	@Override
	public List<AlumnoPrograma> getAlumnoProgramasIdByDNI(String dni) {
		List<AlumnoPrograma> alumnoProgramaList = alumnoProgramaDAO.getAlumnoProgramasIdByDNI(dni); // DEV
		return alumnoProgramaList;
	}
