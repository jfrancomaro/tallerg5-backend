...
public class AlumnoBeneficioController {
	...
	public boolean insertAlumnoBeneficio(@RequestBody AlumnoProgramaBeneficio apbeneficio) {
		logger.info("> insertAlumnoProgramaBeneficio[ "+apbeneficio+"]"+" "+apbeneficio.getIdBeneficio());
		
		boolean resp = false;
		try {
			//alumnobeneficioservice.getIdBeneficio(apbeneficio.getId_abp()) alumnobeneficioservice.getIdBeneficio(apbeneficio.getId_abp())
			logger.info("respppp:  abp "+apbeneficio.getIdApb());
			if(!alumnobeneficioservice.getIdBeneficio(apbeneficio.getIdApb()))
			{
			...
			logger.info("respppp: afte "+apbeneficio.getIdBeneficio()+" "+apbeneficio);
