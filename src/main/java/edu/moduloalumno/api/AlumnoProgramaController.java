...
public class AlumnoProgramaController {
	...
	@RequestMapping(value = "/leer/cod/{cod}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<AlumnoPrograma>> getAlumnoProgramasIdByCod(@PathVariable("cod") String cod)
	{
		logger.info("> getAlumnoProgramasIdByCod [AlumnoPrograma]");
		List<AlumnoPrograma> list = null;
		try {
			list = service.getAlumnoProgramasIdByCod(cod);
			if (list == null) {
				list = new ArrayList<AlumnoPrograma>();
			}
		} catch (Exception e) {
	...
	@RequestMapping(value = "/leer/dni/{dni}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<AlumnoPrograma>> getAlumnoProgramaByDNI(@PathVariable("dni") String dni)
	{
		...
		List<AlumnoPrograma> list = null;
		try {
			list = service.getAlumnoProgramasIdByDNI(dni);
			if (list == null) {
				list = new ArrayList<AlumnoPrograma>();
			}
		} catch (Exception e) {
