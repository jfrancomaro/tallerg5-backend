...
public class AlumnoBeneficioDAOImpl implements IAlumnoBeneficioDAO{
	...
	public boolean insertAlumnoProgramaBeneficio(AlumnoProgramaBeneficio apbeneficio) {
		...
		if(apbeneficio.isToQuery()) {System.out.println("insert");
			sql = "INSERT INTO alumno_programa_beneficio(cod_alumno,id_beneficio,observacion,beneficio_otorgado,id_benef_condicion,fecha,autorizacion,criterio) values (?,?,?,?,?,?,?,?)";
		 	ret = jdbcTemplate.update(sql, apbeneficio.getCodAlumno(),apbeneficio.getIdBeneficio(),apbeneficio.getObservacion(),apbeneficio.getBeneficioOtorgado(),apbeneficio.getIdBenefCondicion(),apbeneficio.getFecha(),apbeneficio.getAutorizacion(),apbeneficio.getCriterio());
		}
			...
			ret = jdbcTemplate.update(sql,apbeneficio.getIdBeneficio(),apbeneficio.getObservacion(),apbeneficio.getBeneficioOtorgado(),apbeneficio.getIdBenefCondicion(),apbeneficio.getFecha(),apbeneficio.getAutorizacion(),apbeneficio.getCriterio(),apbeneficio.getIdApb());
		}
